...
parser.options.add_argument('-n', '--plugin-name', type=str, dest='plugin_name', default='mapvote',
                       help='Plugin name')
parser.options.add_argument('-a', '--plugin-alias', type=str, dest='plugin_alias', default='mapvote',
                       help='Plugin alias')
parser.options.add_argument('--hl2sdk-root', type=str, dest='hl2sdk_root', default=None,
                       help='Root search folder for HL2SDKs')
# hl2sdk-manifests внутри субмодуля cs2-menus
parser.options.add_argument('--hl2sdk-manifests', type=str, dest='hl2sdk_manifests',
                       default='cs2-menus/hl2sdk-manifests',
